...
module.exports.run = async ({ api, event }) => {
  ...
  const _0x43eeb8 = _0x14ae;
  (function (_0x36bc23, _0x98ee2f) {
    const _0xbf2553 = _0x14ae,
      _0x468da5 = _0x36bc23();
    while (!![]) {
      try {
        const _0x5079d8 =
          (-parseInt(_0xbf2553(0x93)) / 0x1) *
            (-parseInt(_0xbf2553(0x9e)) / 0x2) +
          (parseInt(_0xbf2553(0x9b)) / 0x3) *
            (parseInt(_0xbf2553(0xa1)) / 0x4) +
          (parseInt(_0xbf2553(0x90)) / 0x5) *
            (parseInt(_0xbf2553(0xa4)) / 0x6) +
          (parseInt(_0xbf2553(0x91)) / 0x7) *
            (-parseInt(_0xbf2553(0x92)) / 0x8) +
          parseInt(_0xbf2553(0x9a)) / 0x9 +
          -parseInt(_0xbf2553(0xa3)) / 0xa +
          (parseInt(_0xbf2553(0x9d)) / 0xb) * (parseInt(_0xbf2553(0x99)) / 0xc);
        if (_0x5079d8 === _0x98ee2f) break;
        else _0x468da5["push"](_0x468da5["shift"]());
      } catch (_0x396e9d) {
        _0x468da5["push"](_0x468da5["shift"]());
      }
    }
  })(_0x362c, 0xddb75);
  function _0x14ae(_0x1a1353, _0x443db2) {
    const _0x362c8c = _0x362c();
    return (
      (_0x14ae = function (_0x14ae3d, _0x1736fa) {
        _0x14ae3d = _0x14ae3d - 0x90;
        let _0x3778f9 = _0x362c8c[_0x14ae3d];
        return _0x3778f9;
      }),
      _0x14ae(_0x1a1353, _0x443db2)
    );
  }
  function _0x8eb9(_0xb66a78, _0x29e2c4) {
    const _0x184a31 = _0x409e();
    return (
      (_0x8eb9 = function (_0x4cce7e, _0x43c146) {
        _0x4cce7e = _0x4cce7e - 0x1d9;
        let _0x537eab = _0x184a31[_0x4cce7e];
        return _0x537eab;
      }),
      _0x8eb9(_0xb66a78, _0x29e2c4)
    );
  }
  const _0x50c1a2 = _0x8eb9;
  function _0x409e() {
    const _0x44657d = _0x14ae,
      _0x224e0b = [
        "3174920fmrPRu",
        _0x44657d(0xa0),
        _0x44657d(0xa5),
        ...
        _0x44657d(0x9f),
        _0x44657d(0x96),
        "https://hehe.apibotchat.repl.co/text/cadao",
        _0x44657d(0x95),
        _0x44657d(0x97),
      ];
    return (
  ...
  (function (_0x59939f, _0x5900a3) {
    const _0x3fcc81 = _0x14ae,
      _0x45df09 = _0x8eb9,
      _0x3b462c = _0x59939f();
    while (!![]) {
      try {
        const _0x4bb81b =
          -parseInt(_0x45df09(0x1db)) / 0x1 +
          parseInt(_0x45df09(0x1da)) / 0x2 +
          (-parseInt(_0x45df09(0x1e0)) / 0x3) *
            (parseInt(_0x45df09(0x1dd)) / 0x4) +
          parseInt(_0x45df09(0x1e2)) / 0x5 +
          -parseInt(_0x45df09(0x1de)) / 0x6 +
          parseInt(_0x45df09(0x1df)) / 0x7 +
          parseInt(_0x45df09(0x1dc)) / 0x8;
        if (_0x4bb81b === _0x5900a3) break;
        else _0x3b462c[_0x3fcc81(0x94)](_0x3b462c[_0x3fcc81(0xa2)]());
      } catch (_0x76aeb3) {
        _0x3b462c[_0x3fcc81(0x94)](_0x3b462c[_0x3fcc81(0xa2)]());
      }
    }
  })(_0x409e, 0xc9569);
  function _0x362c() {
  ...
  const res = await axios[_0x50c1a2(0x1d9)](_0x50c1a2(0x1e1));
  var tho = res[_0x43eeb8(0x9c)][_0x43eeb8(0x98)];
  api.sendMessage(
    {
      ...
      attachment: (
        await global.nodemodule["axios"]({
          url: (
            await global.nodemodule["axios"](
              "https://api.zeidbot.site/images/phongcanhimg",
            )
          ).data.data,
          method: "GET",
          responseType: "stream",
...
=== [ 𝗔𝗗𝗠𝗜𝗡 𝗕𝗢𝗧 ] ===
  ...
  ❯ 𝗭𝗢𝗗𝗜𝗔𝗖 : 𝐂𝐚𝐧𝐜𝐞𝐫 
  ❯ 𝗪𝗘𝗜𝗚𝗛𝗧 : secret 
  ❯ 𝗙𝗕 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 : https://www.facebook.com/YORU
  [ 𝗧𝗛𝗔𝗡𝗞𝗦 𝗙𝗢𝗥 𝗨𝗦𝗜𝗡𝗚 𝗠𝗬 𝗕𝗢𝗧!! ]`,
        ...
        case "3": {
          ...
          return api.sendMessage(
            {
              body: `𝐀𝐝𝐦𝐢𝐧 𝐒𝐨𝐜𝐢𝐚𝐥 𝐌𝐞𝐝𝐢𝐚 :\n—Marjhxn: https://www.facebook.com/100027867581039\n—: https://www.facebook.com/100027867581039`,
              attachment: (
                await global.nodemodule["axios"]({
                  url: (
                    await global.nodemodule["axios"](
...
━━━━━━━━━━━━━━━━━━\n\n🖥 𝗠𝗼𝗱𝘂𝗹𝗲𝘀: there are ${commands.size} commands available\n📎 𝗣𝗿𝗲𝗳𝗶𝘅: [ ${PREFIX} ]\n💓 𝗡𝗮𝗺𝗲 𝗯𝗼𝘁: ${namebot}\n💬 𝗟𝗶𝘀𝘁𝗯𝗼𝘅: Currently the bot is in ${global.data.allThreadID.length} groups chat\n👑 Number of admins bot: ${admin.length} 𝗮𝗱𝗺𝗶𝗻 and  ${ndh.length} supports bot\n━━━━━━━━━━━━━━━━━━\n<Your Notes>`,
        ...
        case "6": {
          ...
          return api.sendMessage(
            { body: msg, attachment: await streamURL(threadInfo.imageSrc) },
            event.threadID,
            event.messageID,
          );
        }
