...
module.exports.handleEvent = async function ({
  ...
  if (typeof thread["console"] !== "undefined" && thread["console"] == true)
    return;
  if (event.senderID == global.data.botID) return;
  var nameBox =
    global.data.threadInfo.get(event.threadID).threadName ||
    "Name does not exist";
  ...
  console.log(
    chalk.hex("#" + random)(`Group name: ${nameBox}`) +
      " | " +
      chalk.hex("#" + random1)(`User name: ${nameUser}`) +
      " | " +
